...
import id.co.imastudio.kadeproject.fragment.OverviewFragment
import id.co.imastudio.kadeproject.fragment.PlayerFragment
...
class FavoriteTeamDetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val dataTeam: List<FavoriteTeam> = intent.getParcelableArrayListExtra("data")
